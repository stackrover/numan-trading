                    ...
                    <Form {...form}>
                        ...
                        >
                            <div className="text-center w-full space-y-2">
                                <div className="mx-auto w-16 h-16 bg-gradient-to-tr from-primary to-accent rounded-2xl rotate-12 flex items-center justify-center shadow-lg mb-4">
                                    <span className="text-white text-3xl font-bold -rotate-12">N</span>
                                </div>
                                <h1 className="text-3xl font-bold text-white tracking-tight">Create Account</h1>
                                <p className="text-white/60 text-sm">
                                    Join our colors & flavors network
                                </p>
                            </div>
